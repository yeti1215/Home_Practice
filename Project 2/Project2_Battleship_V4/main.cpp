 ...
 * Purpose: project 2# Battle ship Version 4, Two players
 */
...
int main(int argc, char** argv) {
    ...
    string myName,// first player name
     ...
     systemBoard();
     //initialize two player's game board
     initialBoard(myBoard);
     initialBoard(youBoard);
     //input player's name
     cout<<"My name is:"<<endl;
     cin>>myName;
     cout<<"My opponent name:"<<endl;
     cin>>youName;
     decorationLine();
     
    //first player place the ship, 
 ...
 //     displayBoard(youBoard, ROWS);
   ...
   cout<<"WINNER"<<setw(24)<<setfill(' ')<<right<<myName<<endl;
   cout<<setw(30)<<setfill('-')<<"-"<<endl;
   }
  else if(countY==14)
   {
   cout<<setw(30)<<setfill('-')<<"-"<<endl;
   cout<<"WINNER"<<setw(24)<<setfill(' ')<<right<<youName<<endl;
   cout<<setw(30)<<setfill('-')<<"-"<<endl;
